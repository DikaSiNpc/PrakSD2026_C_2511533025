...
public class MahasiswaDriver_2511533025 {
    ...
    public static void tambahMahasiswa(ArrayList<Mahasiswa_2511533025> list, Scanner sc) {
        ...
        list.add(new Mahasiswa_2511533025(nim, nama, prodi));
        System.out.println("Mahasiswa berhasil ditambahkan.");
    }
    // 3. Method untuk tampilkan semua data
    public static void tampilkanSemuaMahasiswa(ArrayList<Mahasiswa_2511533025> list) {
        if (list.isEmpty()) {
            System.out.println("Daftar mahasiswa kosong.");
        } else {
            System.out.println("Data Mahasiswa:");
            for (Mahasiswa_2511533025 mhs : list) {
    ...
    public static void hapusMahasiswa(ArrayList<Mahasiswa_2511533025> list, Scanner sc) {
     ...
     // 5. Method untuk cari mahasiswa berdasarkan NIM
        public static void cariMahasiswa(ArrayList<Mahasiswa_2511533025> list, Scanner sc) {
        ...
        public static void main(String[] args) {
            ArrayList<Mahasiswa_2511533025> mahasiswaList = new ArrayList<>();
